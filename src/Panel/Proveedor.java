...
public class Proveedor extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblListado.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#", "Id", "RUC", "Nombre", "Teléfono", "Email", "Dirección", "Contacto", "Celular de contacto", "Cargo de contacto"
            }
        ) {
    ...
    private void Mostrar(){
        List<dataProveedor> listaProveedor = prov.mostrarProveedor();
        modelo = (DefaultTableModel) tblListado.getModel();
        Object[] ob = new Object[10];
        
        for(int i = 0; i < listaProveedor.size();i++){
            ob[0] = i+1;
            ob[1] = listaProveedor.get(i).getId();
            ob[2] = listaProveedor.get(i).getRuc();
            ob[3] = listaProveedor.get(i).getNombre();
            ob[4] = listaProveedor.get(i).getTelefono();
            ob[5] = listaProveedor.get(i).getEmail();
            ob[6] = listaProveedor.get(i).getDireccion();
            ob[7] = listaProveedor.get(i).getContacto();
            ob[8] = listaProveedor.get(i).getCelular();
            ob[9] = listaProveedor.get(i).getCargo();
            modelo.addRow(ob);
        }
    ...
    void obtenerDatos(){
        ...
        if(fila <= -1){
            ...
            String ruc = (String) tblListado.getValueAt(fila, 2);
            String nombre = (String) tblListado.getValueAt(fila, 3);
            String telefono = (String) tblListado.getValueAt(fila, 4);
            String email = (String) tblListado.getValueAt(fila, 5);
            String direccion = (String) tblListado.getValueAt(fila, 6);
            String contacto = (String) tblListado.getValueAt(fila, 7);
            String celular = (String) tblListado.getValueAt(fila, 8);
            String cargo = (String) tblListado.getValueAt(fila, 9);
            
            InfoProveedor inproveedor = new InfoProveedor(id, ruc, nombre, telefono, email, direccion, contacto, celular, cargo);
            inproveedor.setSize(1100, 700);
            inproveedor.setLocation(0,0);
            panelContent.removeAll();
            panelContent.add(inproveedor,BorderLayout.CENTER);
    ...
    void Eliminar(){
        ...
        if(fila <= -1){
            ...
            dprov.setId((int) tblListado.getValueAt(fila, 1));
    ...
    void Buscar(){
        limpiarTabla();
        List<dataProveedor> listaProveedor = prov.buscarProveedor(getBuscar());
        modelo = (DefaultTableModel) tblListado.getModel();
        Object[] ob = new Object[10];
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        InfoProveedor inproveedor = new InfoProveedor();
        inproveedor.setSize(1100, 700);
        inproveedor.setLocation(0,0);
        panelContent.removeAll();
        panelContent.add(inproveedor,BorderLayout.CENTER);
